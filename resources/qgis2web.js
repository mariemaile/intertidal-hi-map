...
map.getView().fit([-17844262.942988, 2130942.224732, -17227874.211428, 2565325.565671], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Intertidal Biodiversity Patterns in Hawaiʻi</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (595 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This interactive map visualizes intertidal biodiversity observations across Hawaiʻi.<br />Layers show sampling effort, individual observations, and estimated biodiversity hotspots based on species richness.<br /><br />Data source: Intertidal biodiversity observations from the Intertidal of Hawaiʻi project on iNaturalist (https://www.inaturalist.org/projects/intertidal-of-hawai-i). Community science observations contributed by iNaturalist users.<br /><br />Surfrider Foundation Blue Water Task Force. Oʻahu Water Quality Monitoring Data (Enterococcus). Accessed Mar 2026.<br /><br />Map and spatial analysis created using QGIS.';
            }
